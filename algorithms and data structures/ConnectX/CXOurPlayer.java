...
public class CXOurPlayer implements CXPlayer {
    ...
    */
    ...
    private void initDepth(int row, int cols){
        if(cols==4){
            if(row==4) depth = 14; // 4 X 4
            else if(row==5) depth = 18; // 5 X 4
            else if(row==6) depth = 22; // 6 X 4
            else depth = 13; // 7 X 4
        } else if(cols == 5){
            if(row==4) depth = 18; // 4 X 5
            else depth = 11; // 5 X 5, 6 X 5, 7 X 5
    ...
    */
    ...
    private int evaluate(CXBoard B) throws TimeoutException {
        if(B.gameState() == myWin) return WIN;
        else if(B.gameState() == yourWin) return LOSE;
        else if(B.gameState() == CXGameState.DRAW) return DRAW;
        else {
