// site212234.tw.cs.unibo.it/backoffice/services/showoffice

// require
const { header, scripts } = require('../../../public/js/utils/template')

// render home
exports.renderShowOffices = async (req,res) => {
    ...
    <div class="container text-center mt-2">
        <button class="btn btn-secondary btn-lg" onclick="searchOffice()">Cerca</button>
    </div>
    </div>
    <hr>
    ...
    let showOffice = header('Backoffice | Servizi | Aggiungi', 'services-script') + body
